<template>
  <div class="row">
    ...
    <md-button class="md-success md-hue-1" @click="approveAll()"> Approve All </md-button>
    <div class="col-md-12">
      <b-table
        striped
        hover
  ...
  methods: {
    ...
    msg(param, nim) {
      if (param) {
        ...
        //   icon: "success",
        // });
        this.$toasted.show("SKL " + nim + " berhasil ditanda tangani dan dikirimkan..!");
      } else {
        // swal({
    ...
    approveAll() {
      this.$toasted.show("Semua SKL berhasil ditanda tangani dan dikirimkan..!");
    },
  },
  mounted() {
    const user = "user";
