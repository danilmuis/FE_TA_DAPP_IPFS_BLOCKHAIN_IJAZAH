<template>
    ...
    <div class="bg-blue" style="height:80%">
        <div id="particles-js"  ></div><br><br>
    <div class="card card-bege" >
                        <div class="card-header text-center border border-success  ">
                            <h6 style="color:blue;">Choose Access</h6>
                        </div>
